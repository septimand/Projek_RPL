                                        ...
                                        <div class="card-body py-4">
                                            <div class="d-flex align-items-start">
                                                <div class="flex-grow-1">
                                                    ...
                                                    <h3 class="mb-2">{{$ST}}</h3>
                                                    <a class="mb-0" href="/buatSuratTugasMHS">Lihat detail</a>
                                                </div>
                                ...
                                <div class="col-sm-6 d-inline-flex">
                                    <div class="card flex-fill" style="background-color: #6D8BA5">
                                        <div class="card-body py-4">
                                            <div class="d-flex align-items-start">
                                                <div class="flex-grow-1">
                                                    <p class="mb-0" style="color: white;">Surat Keterangan Kegiatan Mahasiswa</p>
                                                    <h3 class="mb-2" style="color: white;">{{$SKKM}}</h3>
                                                    <a class="mb-0" href="/buatSuratKKMMHS" style="color:#89C5CC;">Lihat detail</a>
                                                </div>
                                                <div class="d-inline-block ms-3">
                                                    <div class="stat mt-2">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="70" height="70" fill="#507A9E" class="bi bi-tag" viewBox="0 0 16 16">
