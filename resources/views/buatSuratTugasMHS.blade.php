...
<div class="container-fluid">
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <div>
           <ul>
           <a class="btn btn-primary me-md-2" href="/buatSuratTugasMHS/suratTugasMHS" role="button">Buat Surat  (+)</a>
          </ul>
      </div>
            ...
            <thead>
                ...
                <tbody>
                    ...
                    <td>
                        ...
                        @if($k->status != 'Disetujui')
                        <a class="btn btn-warning" href="buatSuratTugasMHS/editSTMHS/{{$k->id_surat}}" role="button"><span data-feather="edit"></span></a>
                        <a class="btn btn-danger" href="buatSuratTugasMHS/deleteST/{{$k->id_surat}}" role="button"><span data-feather="trash"></span></a>
                        @endif
                    </td>
                    </tr>
                    <!-- Modal View -->
