  ...
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="nav-link active">
        ...
        <a> &nbsp > &nbsp</a>
        <a class="h6" href="/buatSuratTugasMHS/editSTMHS/{{$k->id_surat}}" type="button" style="text-decoration:none">Edit Surat Tugas</a>
      </div>
        <form method="post" action="/buatSuratTugasMHS/updateST">
            {{csrf_field()}}
