  ...
  <div class="row">
      ...
      <div class="position-sticky pt-3">
        <ul class="nav flex-column">
          ...
          <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
            ...
            <li><a class="dropdown-item active" href="/suratKeluarMHS">Surat Keluar</a></li>
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <a class="h6" href="#" type="button" style="text-decoration:none">Surat</a>
        <a> &nbsp > &nbsp</a>
        <a class="h6" href="/suratKeluarMHS" type="button" style="text-decoration:none">Surat Keluar</a>
      </div>
        <table class="table">
            <thead>
                <tr>
