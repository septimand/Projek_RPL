...
<div class="container-fluid">
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <div>
           <ul>
           <a class="btn btn-primary me-md-2" href="/buatSuratPersonaliaDSN/suratPersonaliaDSN" role="button">Buat Surat  (+)</a>
          </ul>
      </div>
        <table class="table">
            <thead>
                ...
                <tbody>
                    ...
                    <a class="btn btn-primary" href="#" role="button" data-bs-toggle="modal" data-bs-target="#viewSPModal<?php echo $no  ?>"><span data-feather="eye"></span></a>
                      @if($k->status != 'Disetujui')
                        <a class="btn btn-warning" href="buatSuratPersonaliaDSN/editSPDSN/{{$k->id_surat}}" role="button"><span data-feather="edit"></span></a>
                        <a class="btn btn-danger" href="buatSuratPersonaliaDSN/deleteSP/{{$k->id_surat}}" role="button"><span data-feather="trash"></span></a>
                        @endif
                    </td>
                    </tr>
                     <!-- Modal View-->
