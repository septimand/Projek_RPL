  ...
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="nav-link active">
        ...
        <a> &nbsp > &nbsp</a>
        <a class="h6" href="/buatSuratTugas/editST/{{$k->id_surat}}" type="button" style="text-decoration:none">Edit Surat Tugas</a>
      </div>
        <form method="post" action="/buatSuratTugas/updateST">
            {{csrf_field()}}
            ...
            <div class="row">
                ...
                <div class="row">
                    <div class="col-5">
                        ...
                        <input type="text" class="form-control " onkeyup="isi_otomatis()" id="nomor_induk" name="no_induk"  value="{{$k->no_induk}}" required>
                    </div>
                    <div class="col-7">
                        <label class="form-label">Nama</label>
                        <input type="text" class="form-control" id="nama_user" name="name" value="{{$k->name}}" required>
                    </div>
                    </div-->
                </div>
                <div class="mb-3">
