...
<div class="container-fluid">
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <div>
           <ul>
           <a class="btn btn-primary me-md-2" href="/buatSuratBA/beritaAcara" role="button">Buat Surat  (+)</a>
          </ul>
      </div>
        <table class="table">
            <thead>
                ...
                <tbody>
                    ...
                    <td>
                        ...
                        @if($k->status != 'Disetujui')
                        <a class="btn btn-warning" href="buatSuratBA/editBA/{{$k->id_surat}}" role="button"><span data-feather="edit"></span></a>
                        <a class="btn btn-danger" href="buatSuratBA/deleteBA/{{$k->id_surat}}" role="button"><span data-feather="trash"></span></a>
                        @endif
                        @if($k->id_pejabat != null)
                        <a class="btn btn-info" href="buatSuratBA/cetakSuratBA/{{$k->id_surat}}" role="button"><span data-feather="download-cloud"></span></a>
                        @endif
                    </td>
                    </tr>
                            ...
                            <div class="modal-body">
                              <div class="row">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" disabled class="form-control" id="Temakegiatan" name="tema_kgt" value="{{$k->tema_kgt}}" >
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label"> Tanggal</label>
                                        <input type="date" disabled class="form-control" id="Tempatkegiatan" name="tgl_laksanakan" value="{{$k->tgl_laksanakan}}">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label"> Tempat</label>
                                        <input type="text" disabled class="form-control" id="tanngalkegiatan" name="tmpt_kgt" value="{{$k->tmpt_kgt}}" >
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label"> Narasumber</label>
                                        <input type="text" disabled class="form-control" id="Penyelenggarakegiatan" name="kepada" value="{{$k->kepada}}" >
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label"> Target Peserta Kegiatan</label>
                                        <input type="text" disabled class="form-control" id="Harikegiatan" name="keterangan_surat" value="{{$k->keterangan_surat}}" >
                                    </div>
                                </div>
                            </div>
