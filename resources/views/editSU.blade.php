...
<div class="container-fluid">
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <a> &nbsp > &nbsp</a>
        <a class="h6" href="/buatSuratUndangan/editSU/{{$k->id_surat}}" type="button" style="text-decoration:none">Edit Surat Undangan</a>
      </div>
      <form method="post" action="/buatSuratUndangan/updateSU">
      {{csrf_field()}}
