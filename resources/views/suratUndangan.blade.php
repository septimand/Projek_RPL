...
<div class="container-fluid">
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <a> &nbsp > &nbsp</a>
        <a class="h6" href="/buatSuratUndangan/suratUndangan" type="button" style="text-decoration:none">Surat Undangan</a>
      </div>
      <form method="post" action="/buatSurat/simpanSU">
      <input type="hidden" name="_token" value="{{ csrf_token() }}" />
          <div class="row">
          <input type="hidden" class="form-control" id="jenis_surat" name="jenis_surat" value ="Surat Undangan">
