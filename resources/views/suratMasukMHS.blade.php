  ...
  <div class="row">
      ...
      <div class="position-sticky pt-3">
        <ul class="nav flex-column">
          ...
          <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
            <li><a class="dropdown-item active" href="/suratMasukMHS">Surat Masuk</a></li>
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <a class="h6" href="#" type="button" style="text-decoration:none">Surat</a>
        <a> &nbsp > &nbsp</a>
        <a class="h6" href="/suratMasukMHS" type="button" style="text-decoration:none">Mengelolah Surat Masuk</a>
      </div>
        <table class="table">
            <thead>
                <tr>
                ...
                <tbody>
                    ...
                    <td>
                        @if($m->id_pejabat != null)
                            ...
                            <a class="btn btn-info" href="suratMasukMHS/cetakST1/{{$m->id_surat}}" role="button"><span data-feather="download-cloud"></span></a>
                            @elseif ($m->jenis_surat == 'Surat Keterangan Kegiatan Mahasiswa')
                            <a class="btn btn-info" href="suratMasukMHS/cetakSuratKKM/{{$m->id_surat}}" role="button"><span data-feather="download-cloud"></span></a>
                            @endif
                        @endif
                    </td>
                    </tr>
