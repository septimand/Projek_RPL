                                        ...
                                        <div class="card-body py-4">
                                            <div class="d-flex align-items-start">
                                                <div class="flex-grow-1">
                                                    <p class="mb-0" style="color: white;">Surat Tugas</p>
                                                    
                                                    <h3 class="mb-2" style="color: white;">{{$ST}}</h3>
                                                    
                                                    <a class="mb-0" href="/buatSuratTugas" style="color:#89C5CC;">Lihat detail</a>
                                                </div>
                                ...
                                <div class="col-sm-6 d-inline-flex">
                                    <div class="card flex-fill" style="background-color: #39D5D5">
                                        <div class="card-body py-4">
                                            <div class="d-flex align-items-start">
                                                <div class="flex-grow-1">
                                                    <p class="mb-0">Surat Personalia</p>
                                                    <h3 class="mb-2">{{$SP}}</h3>
                                                    <a class="mb-0" href="/buatSuratPersonalia">Lihat detail</a>
                                                </div>
                                                <div class="d-inline-block ms-3">
                                                    <div class="stat mt-2">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="70" height="70" fill="#507A9E" class="bi bi-tag" viewBox="0 0 16 16">
                                ...
                                <div class="col-sm-6 d-inline-flex">
                                    <div class="card flex-fill" style="background-color: #39D5D5">
                                        <div class="card-body py-4">
                                            <div class="d-flex align-items-start">
                                                <div class="flex-grow-1">
                                                    <p class="mb-0">Surat Undangan</p>
                                                    <h3 class="mb-2">{{$SU}}</h3>
                                                    <a class="mb-0" href="/buatSuratUndangan">Lihat detail</a>
                                                </div>
                                                <div class="d-inline-block ms-3">
                                                    <div class="stat mt-2">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="70" height="70" fill="#507A9E" class="bi bi-tag" viewBox="0 0 16 16">
                                ...
                                <div class="col-sm-6 d-inline-flex">
                                    <div class="card flex-fill" style="background-color: #6D8BA5">
                                        <div class="card-body py-4">
                                            <div class="d-flex align-items-start">
                                                <div class="flex-grow-1">
                                                    <p class="mb-0" style="color: white;">Surat Keterangan Kegiatan Mahasiwa </p>
                                                    
                                                    <h3 class="mb-2" style="color: white;">{{$SKKM}}</h3>
                                                    
                                                    <a class="mb-0" href="/buatSuratKKM" style="color:#89C5CC;">Lihat detail</a>
                                                </div>
                                                <div class="d-inline-block ms-3">
                                                    <div class="stat mt-2">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="70" height="70" fill="#507A9E" class="bi bi-tag" viewBox="0 0 16 16">
                                ...
                                <div class="col-sm-6 d-inline-flex">
                                    <div class="card flex-fill" style="background-color: #6D8BA5">
                                        <div class="card-body py-4">
                                            <div class="d-flex align-items-start">
                                                <div class="flex-grow-1">
                                                    <p class="mb-0" style="color: white;">Berita acara </p>
                                                    
                                                    <h3 class="mb-2" style="color: white;">{{$BA}}</h3>
                                                    
                                                    <a class="mb-0" href="/buatSuratBA" style="color:#89C5CC;">Lihat detail</a>
                                                </div>
                                                <div class="d-inline-block ms-3">
                                                    <div class="stat mt-2">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="70" height="70" fill="#507A9E" class="bi bi-tag" viewBox="0 0 16 16">
                                ...
                                <div class="col-sm-6 d-inline-flex">
                                    <div class="card flex-fill" style="background-color: #39D5D5">
                                        <div class="card-body py-4">
                                            <div class="d-flex align-items-start">
                                                <div class="flex-grow-1">
                                                    <p class="mb-0">Surat Keterangan Aktif</p>
                                                    <h3 class="mb-2">{{$SKA}}</h3>
                                                    <a class="mb-0" href="/buatSuratKeterangan">Lihat detail</a>
                                                </div>
                                                <div class="d-inline-block ms-3">
                                                    <div class="stat mt-2">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="70" height="70" fill="#507A9E" class="bi bi-tag" viewBox="0 0 16 16">
